...
exports.getCustomerProfile = async (req, res) => {
  ...
  try {
    ...
    res
      .status(500)
      .send({ msg: '获取用户资料失败。', err: err.message });
  }
};
...
exports.UpdateProfilePhoto = async (req, res) => {
  ...
  try {
    ...
    res
      .status(500)
      .json({ msg: '更新头像照片失败', err: err.message });
  }
};
...
exports.addVideoInCollection = async (req, res) => {
  ...
  try {
    ...
    res
      .status(500)
      .json({ msg: '添加视频到收藏集合失败', err: err.message });
  }
};