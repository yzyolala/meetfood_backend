...
let wasm;
const { log, setLogger } = require(String.raw`./snippets/native-iast-rewriter-24b74ee2d3e96971/tracer_logger.js`);
...
module.exports.__wbg_readFileSync_9e637be039953741 = function() { return handleError(function (arg0, arg1) {
    const ret = readFileSync(getStringFromWasm0(arg0, arg1));
    return addHeapObject(ret);
}, arguments) };

module.exports.__wbg_dirname_16e6b08fb4137c3d = function() { return handleError(function (arg0, arg1) {
...
module.exports.__wbg_log_25c13d4813205ea0 = function() { return handleError(function (arg0, arg1) {
    const ret = log(getObject(arg0), getObject(arg1));
    return addHeapObject(ret);
}, arguments) };

module.exports.__wbg_setLogger_bf4ec23b45b2b814 = function() { return handleError(function (arg0) {
